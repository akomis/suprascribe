...
export const metadata: Metadata = buildMetadata({
  title: 'Subscription Cost Calculator - Free',
  description:
    'Free subscription cost calculator. Add your subscriptions, mix monthly, yearly, quarterly, and weekly billing, and get your true total. No signup.',
