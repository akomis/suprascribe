...
export const metadata: Metadata = buildMetadata({
  title: 'Free Subscription Tracker - Find Them All',
  description:
    'Track all your subscriptions for free. Suprascribe scans Gmail, Outlook, and iCloud to find the ones you forgot - no bank access, no recurring fees.',
