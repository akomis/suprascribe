...
export const metadata: Metadata = {
  title: 'Free Subscription Tracker - Find Every Subscription Automatically | Suprascribe',
  description:
...
const jsonLd = {
  ...
  '@graph': [
    ...
    {
      '@type': 'FAQPage',
      mainEntity: trackerFaqItems.map((item) => ({
        '@type': 'Question',
        name: item.question,
    ...
    },
    {
      ...
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.suprascribe.com' },
        {
          '@type': 'ListItem',
          position: 2,
          name: 'Free Subscription Tracker',
          item: 'https://www.suprascribe.com/free-subscription-tracker',
        },
      ],
    },
  ],
