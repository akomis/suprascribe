...
export const metadata: Metadata = buildMetadata({
  title: 'Outlook Subscription Tracker - Find Every Subscription in Your Inbox',
  description:
    'Automatically find every subscription buried in Outlook, Hotmail, or Live. Suprascribe scans your inbox via Microsoft OAuth to surface recurring payments - no bank access, no password shared, free forever.',
...
export default function OutlookSubscriptionTrackerPage() {
  return (
    <SEOPage
      jsonLd={jsonLd}
      path="/outlook-subscription-tracker"
      title="Outlook Subscription Tracker: Find Every Subscription Hidden in Your Inbox"
