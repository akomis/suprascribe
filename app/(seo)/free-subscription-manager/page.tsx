...
export const metadata: Metadata = {
  title: 'Free Subscription Manager - Organize, Cancel & Track | Suprascribe',
  description:
...
const jsonLd = {
  ...
  '@graph': [
    ...
    {
      '@type': 'FAQPage',
      mainEntity: managerFaqItems.map((item) => ({
        '@type': 'Question',
        name: item.question,
    ...
    },
    {
      ...
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.suprascribe.com' },
        {
          '@type': 'ListItem',
          position: 2,
          name: 'Free Subscription Manager',
          item: 'https://www.suprascribe.com/free-subscription-manager',
        },
      ],
    },
  ],
    ...
    >
      ...
      <section className="container mx-auto px-4 py-12 sm:py-20 max-w-3xl">
        <div className="space-y-8">
          <div className="text-center space-y-3">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">
              What Makes a Good Subscription Manager?
            </h2>
          </div>
          <div className="space-y-5 text-muted-foreground">
            ...
            <p>
              ...
              proactive reminders that make the tool genuinely powerful for heavy subscription
              users.
            </p>
          </div>
        </div>
