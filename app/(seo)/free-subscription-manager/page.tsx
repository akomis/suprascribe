...
export const metadata: Metadata = buildMetadata({
  title: 'Free Subscription Manager - Cancel & Track',
  description:
    'Manage every subscription in one place for free. Organize, cancel, set renewal reminders, and see a spending calendar - without paying a monthly fee.',
