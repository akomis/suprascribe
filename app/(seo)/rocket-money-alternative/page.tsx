...
export const metadata: Metadata = buildMetadata({
  title: 'Best Rocket Money Alternative (No Bank)',
  description:
    'A Rocket Money alternative that never asks for bank account access. Suprascribe finds subscriptions by scanning email - free, one-time PRO upgrade.',
