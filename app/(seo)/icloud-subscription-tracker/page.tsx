...
export const metadata: Metadata = buildMetadata({
  title: 'iCloud Subscription Tracker - Find Every Subscription in Your Inbox',
  description:
    'Automatically find every subscription buried in iCloud Mail. Suprascribe connects over IMAP with a revocable app-specific password to surface recurring payments - no bank access, no Apple ID password shared.',
...
export default function IcloudSubscriptionTrackerPage() {
  return (
    <SEOPage
      jsonLd={jsonLd}
      path="/icloud-subscription-tracker"
      title="iCloud Subscription Tracker: Find Every Subscription Hidden in Your Inbox"
