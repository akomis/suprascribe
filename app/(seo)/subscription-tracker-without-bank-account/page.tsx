...
export const metadata: Metadata = buildMetadata({
  title: 'Subscription Tracker, No Bank Account',
  description:
    'A subscription tracker that never asks for your bank account. Suprascribe scans your email instead of linking to Plaid - free, private, one-time PRO.',
