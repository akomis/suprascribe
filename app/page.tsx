...
export const metadata: Metadata = {
  title: 'Free Subscription Tracker & Manager | Suprascribe',
  description:
          ...
          <section className="container mx-auto py-20 px-4">
            <div className="mx-auto max-w-5xl space-y-8 text-center">
              <div className="space-y-4 text-lg text-muted-foreground text-start">
                ...
                <p>
                  Suprascribe is fully open source. You can inspect the code, verify how your data
                  is handled, and contribute.
                </p>
              </div>
