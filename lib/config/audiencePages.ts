...
export const audiencePages: Record<AudienceId, AudiencePageConfig> = {
  business: {
    ...
    metaTitle: 'Subscription Tracking for Business - See Every Tool You Pay For',
    metaDescription:
  ...
  startups: {
    ...
    topics: ['software', 'money', 'tools'],
    metaTitle: 'Subscription Tracking for Startups - Know Your Real SaaS Burn',
    metaDescription:
  ...
  freelancers: {
    ...
    topics: ['software', 'money', 'tools'],
    metaTitle: 'Subscription Tracking for Freelancers - Separate Work From Personal',
    metaDescription:
  ...
  families: {
    ...
    metaTitle: 'Subscription Tracking for Families - One List for the Whole Household',
    metaDescription:
  ...
  students: {
    ...
    topics: ['streaming', 'money', 'tools'],
    metaTitle: 'Subscription Tracking for Students - See What You Actually Pay Each Month',
    metaDescription:
