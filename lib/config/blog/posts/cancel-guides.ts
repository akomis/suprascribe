...
export const cancelGuides: BlogPost[] = [
  {
    ...
    title: 'Cancel a Netflix Subscription in 2026 (Web, App, Apple, Google)',
    metaTitle: 'How to Cancel Netflix in 2026',
    description:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'Cancel Netflix on the Web',
        badge: 'Recommended',
      },
      {
        type: 'p',
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Netflix',
      },
      {
        type: 'p',
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Amazon Prime',
    description:
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Disney+ in 2026',
    description:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Disney+',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'Cancel Spotify on the Web',
      },
      {
        type: 'p',
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Adobe Creative Cloud',
    description:
    ...
    metaDescription:
      'Cancel Adobe Creative Cloud without the early-termination fee: the annual-plan trap, the 14-day refund window, and what happens to your files afterwards.',
    publishedAt: '2026-07-26',
    updatedAt: '2026-09-02',
    readingTimeMin: 7,
    intro:
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Planet Fitness',
    description:
    ...
    metaDescription:
      'Cancel Planet Fitness when it demands you do it in person or by certified letter: the exact process, a cancellation-letter template, and the annual fee.',
    publishedAt: '2026-07-26',
    updatedAt: '2026-09-02',
    readingTimeMin: 6,
    intro:
  ...
  },
  {
    ...
    topics: ['cancel', 'software'],
    title: 'Cancel a ChatGPT Subscription on Web, iPhone, or Android',
    metaTitle: 'How to Cancel a ChatGPT Subscription',
    description:
    ...
    metaDescription:
      'Cancel a ChatGPT subscription where you bought it - chatgpt.com, Apple, or Google Play - keep access until the period ends, and know when refunds apply.',
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Hulu in 2026',
    description:
    ...
    metaDescription:
      'Cancel Hulu on the web or app, through the Disney bundle, or via Apple, Google, Amazon, or your cable provider - and keep watching until the period ends.',
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Hulu',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel YouTube Premium in 2026',
    description:
    ...
    metaDescription:
      'Cancel YouTube Premium or YouTube Music on the web or through Apple and Google Play billing - and keep playlists and downloads until the period ends.',
    publishedAt: '2026-09-01',
    updatedAt: '2026-09-02',
    readingTimeMin: 4,
    intro:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel YouTube Premium',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Apple TV+',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Max',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Paramount+ in 2026',
    description:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'Cancel Paramount+ on the Web',
        badge: 'Recommended',
      },
      {
        type: 'ol',
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Paramount+',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Peacock in 2026',
    description:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'Cancel Peacock on the Web',
        badge: 'Recommended',
      },
      {
        type: 'ol',
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Peacock',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Audible in 2026',
    description:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'Cancel Audible on the Web',
      },
      {
        type: 'ol',
        items: [
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Audible',
      },
      {
        type: 'table',
        table: {
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Xbox Game Pass in 2026',
    description:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'Cancel Xbox Game Pass on the Web',
        badge: 'Recommended',
      },
      {
        type: 'ol',
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Game Pass',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'Cancel LinkedIn Premium on the Web',
        badge: 'Recommended',
      },
      {
        type: 'ol',
      ...
      {
        type: 'h2',
        text: 'Cancel LinkedIn Premium on iPhone or Android',
      },
      {
        type: 'p',
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel LinkedIn Premium',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel a Gym Membership in 2026',
    description:
    ...
    metaDescription:
      "Cancel gym memberships at LA Fitness, 24 Hour Fitness, Gold's Gym, Equinox, Crunch, and Anytime Fitness - online, in person, or by certified mail.",
    publishedAt: '2026-09-01',
    updatedAt: '2026-09-02',
    readingTimeMin: 7,
    intro:
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Microsoft 365 in 2026',
    description:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'Cancel Microsoft 365 on the Web',
        badge: 'Recommended',
      },
      {
        type: 'ol',
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Microsoft 365',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'Cancel Canva on iPhone or Android',
      },
      {
        type: 'p',
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Canva PRO',
      },
      {
        type: 'ul',
        items: [
  ...
  },
  {
    ...
    metaDescription:
      'Cancel Dropbox Plus, Family, Professional, or Business from account settings - and know what happens to your storage and files when the subscription ends.',
    publishedAt: '2026-09-01',
    updatedAt: '2026-09-02',
    readingTimeMin: 5,
    intro:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'Cancel Dropbox on the Web',
        badge: 'Recommended',
      },
      {
        type: 'ol',
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel Dropbox',
      },
      {
        type: 'table',
        table: {
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel SiriusXM in 2026',
    description:
    ...
    metaDescription:
      'Cancel SiriusXM online, by chat, or by phone - and handle the retention offers and car trial subscriptions that make leaving harder than it should be.',
    publishedAt: '2026-09-01',
    updatedAt: '2026-09-02',
    readingTimeMin: 6,
    intro:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel SiriusXM',
      },
      {
        type: 'ul',
        items: [
