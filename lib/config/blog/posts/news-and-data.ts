...
export const newsAndData: BlogPost[] = [
  {
    ...
    metaTitle: 'US Subscription Spending: 2025 Survey',
    description:
    ...
    metaDescription:
      'A 2025 CNET survey puts US subscription spending at about $1,080 a year - with roughly $200 of that wasted on services people barely use.',
  ...
  },
  {
    ...
    topics: ['data', 'policy'],
    title: 'Car feature subscriptions: BMW dropped the fee, not the model',
    metaTitle: 'Car Feature Subscriptions Explained',
    description:
    ...
    metaDescription:
      'BMW charged for heated seats already fitted to the car, then backed down. Car feature subscriptions did not go away - here is where they stand in 2026.',
  ...
  },
  {
    ...
    metaTitle: 'Netflix Price Increase 2026: New Prices',
    description:
    ...
    metaDescription:
      'The March 2026 Netflix price increase raised every US plan, the second hike in under two years. The new prices, and what it does to your monthly total.',
    publishedAt: '2026-07-16',
    updatedAt: '2026-09-02',
    subscriptionEra: true,
  ...
  },
  {
    ...
    metaTitle: 'FTC Click-to-Cancel Rule: 2026 Status',
    description:
    ...
    metaDescription:
      'The FTC Click-to-Cancel rule was finalized, struck down, and revived. Where it stands in 2026, and how to force a cancellation a company is stalling.',
