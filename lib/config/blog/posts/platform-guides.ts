...
export const platformGuides: BlogPost[] = [
  {
    ...
    metaTitle: 'How to Cancel Forgotten Subscriptions',
    description:
  ...
  },
  {
    ...
    metaTitle: 'How to Find All Your Subscriptions',
    description:
    ...
    sections: [
      ...
      },
      {
        ...
        image: {
          ...
          alt: 'Provider picker for Gmail, Outlook and iCloud, noting only subject lines are read',
          caption:
      ...
      },
      {
        ...
        image: {
          ...
          alt: 'Review screen listing scanned subscriptions with billing period, price, edit and reject buttons',
          caption:
      ...
      },
      {
        ...
        image: {
          ...
          alt: 'Subscription dashboard listing inbox-discovered services with monthly and yearly totals',
          caption:
  ...
  },
  {
    ...
    title: 'Cancel Subscriptions on iPhone: Find Every One in Settings',
    metaTitle: 'How to Cancel Subscriptions on iPhone',
    description:
    ...
    metaDescription:
      'Cancel every App Store subscription from iPhone Settings - plus the recurring charges Apple never shows you because they are billed outside the App Store.',
  ...
  },
  {
    ...
    metaTitle: 'How to Cancel Subscriptions on Android',
    description:
    ...
    metaDescription:
      'Cancel, pause, or restore any Google Play subscription from the app or the web - and find the recurring Android charges Google Play never lists for you.',
    publishedAt: '2026-07-29',
    updatedAt: '2026-09-02',
    readingTimeMin: 6,
    intro:
    ...
    sections: [
      ...
      {
        type: 'h2',
        text: 'What Happens After You Cancel on Android',
      },
      {
        type: 'p',
  ...
  },
  {
    ...
    metaTitle: 'Track Subscriptions on iPhone & Android',
    description:
