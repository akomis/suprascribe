...
export const comparisonGuides: BlogPost[] = [
  {
    ...
    faq: [
      {
        ...
        answer:
          "Usually a cap on how many subscriptions you can add - Bobby charges $0.99 to lift its limit, and ReSubs reserves unlimited tracking for Premium - or a paywall on the features that make the tool useful, like renewal reminders, automatic discovery, and sorting. Subby is unlimited but ad-supported, YNAB's free tier is only a 34-day trial, and PocketGuard retired its free plan in 2026. A genuinely free tier should handle an unlimited number of subscriptions with the core features intact.",
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Bobby', 'Capped; unlock costs $0.99', 'Manual only', 'No'],
            ['ReSubs', 'Capped', 'Manual; Gmail import is a Premium feature', 'No'],
            [
              'Rocket Money',
              'Yes, detection included',
              'Automatic, from your transactions',
              'Yes, via Plaid',
            ],
            [
              'YNAB',
              '34-day trial only',
              'None - you spot recurring charges yourself',
              'Optional; manual and file import also supported',
            ],
          ],
        },
      },
      ...
      {
        type: 'h2',
        text: 'What the Best Alternatives Do Well',
      },
      {
        type: 'p',
        text: 'The bank-linked apps are not popular by accident. Rocket Money includes subscription detection on its free tier and adds real value through bill negotiation and a cancellation concierge that handles the providers most people dread calling. PocketGuard offers a fuller budgeting experience across iOS, Android and web, with spending insights and a lifetime purchase option for users who want to avoid another monthly charge. Both deliver automatic discovery without requiring you to touch an inbox.',
        links: [
      ...
      {
        type: 'p',
        text: 'On the no-bank side, Bobby remains one of the nicest manual trackers for Apple users, with polished design, Apple Watch support and a cheap one-time unlock. Subby offers a genuinely unlimited free tier that is hard to argue with, and ReSubs brings Gmail import and AI extraction to a clean mobile app. Each of these tools makes a different trade-off, and each solves a real use case well.',
        links: [
          { text: 'Bobby', href: '/compare/bobby' },
          { text: 'Subby', href: '/compare/subby' },
          { text: 'ReSubs', href: '/compare/resubs' },
        ],
      },
      {
        type: 'h2',
  ...
  },
  {
    ...
    metaTitle: 'The Best Subscription Tracker Apps 2026',
    description:
    ...
    metaDescription:
      'The best subscription tracker apps in 2026 compared: which need bank access, which charge monthly, and which are free. Picks for privacy and automation.',
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Suprascribe (email scanning, unlimited free tier, one-time PRO), Bobby (Apple-only, manual, capped free tier) and Subby (mobile, manual, unlimited but ad-supported). Of those, only Suprascribe finds subscriptions automatically - Bobby and Subby require you to type in every one, which means they only ever contain the subscriptions you already remembered.',
      },
      {
    ...
    sections: [
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              'Bank transactions',
              'Yes, detection included',
              '$7-$14/mo (pay what you want)',
              'Yes, via Plaid',
            ],
            [
              'PocketGuard',
              'Bank transactions',
              'Retired in 2026; 7-day trial',
              '$12.99/mo, $74.99/yr, $149.99 lifetime',
              'Yes',
            ],
            [
              'YNAB',
              'Nothing automatic - transactions only',
              '34-day trial only',
              '$14.99/mo or $109/yr',
              'Optional',
            ],
            ['Bobby', 'Manual entry', 'Capped', '$2.99 one-time, Apple devices only', 'No'],
            [
              'Subby',
              'Manual entry',
            ...
            ['Unsubby', 'Bank transactions', '7-day trial', '$27.99 per 4 weeks', 'Yes, via Plaid'],
          ],
        },
      },
      {
      ...
      },
      {
        ...
        image: {
          ...
          alt: 'Suprascribe dashboard: a donut chart of monthly spend above the active subscription list',
          caption:
      ...
      {
        type: 'h3',
        text: 'What Rocket Money does well',
      },
      {
        type: 'p',
        text: 'Rocket Money is one of the most capable bank-linked finance apps available. Its subscription detection is genuinely useful and included on the free tier, which lowers the barrier to getting a first audit done. Where it really stands out is the breadth of the product beyond tracking: bill negotiation, cancellation concierge services and broad budgeting features give users a single place to manage much of their financial life.',
      },
      {
        type: 'p',
        text: 'For people who want a full-service money app and are comfortable linking their accounts, Rocket Money offers a lot of value. The cancellation concierge in particular saves time on services that otherwise require phone calls or chat queues to leave.',
        links: [{ text: 'Rocket Money', href: '/compare/rocket-money' }],
      },
      {
        type: 'h2',
      ...
      {
        type: 'h3',
        text: 'What PocketGuard does well',
      },
      {
        type: 'p',
        text: 'PocketGuard is the most feature-rich of the bank-linked options. It is available on iOS, Android and web, auto-detects subscriptions from connected accounts, and wraps everything in a full budgeting experience with spending insights and bill negotiation. The lifetime purchase option is also a real differentiator for users who would rather pay once than commit to another monthly subscription.',
      },
      {
        type: 'p',
        text: 'If you want a broad financial dashboard and do not mind bank linking, PocketGuard covers a lot of ground. Subscription tracking sits naturally inside a bigger picture of income, bills and spending goals, which is exactly what some users are looking for.',
        links: [{ text: 'PocketGuard', href: '/compare/pocketguard' }],
      },
      {
        type: 'h2',
      ...
      {
        type: 'h3',
        text: 'What YNAB does well',
      },
      {
        type: 'p',
        text: 'YNAB is the strongest choice for people who want a complete budgeting system rather than a narrow tracker. Its zero-based, give-every-dollar-a-job methodology has helped a large community change how they think about money, and the company backs that methodology with excellent educational content. The reporting is detailed and flexible, and the app is available on the web plus all major mobile platforms.',
      },
      {
        type: 'p',
        text: 'If you are serious about budgeting and want subscriptions to sit inside a bigger financial plan, YNAB is hard to beat. It is overkill for tracking alone, but that is because it was built for a much larger job.',
        links: [{ text: 'YNAB', href: '/compare/ynab' }],
      },
      {
        type: 'h2',
      ...
      {
        type: 'p',
        text: 'Bobby is a long-running, beautifully designed Apple tracker with Apple Watch support and a cheap one-time unlock - $2.99 for the All-in-one Pack, or $0.99 just to lift the subscription limit. It is fully manual and Apple-only, so it is ideal if you live in the Apple ecosystem and do not mind entering subscriptions yourself - but the free tier is capped until you pay.',
      },
      {
        type: 'ul',
        items: [
      ...
      {
        type: 'h3',
        text: 'What Bobby does well',
      },
      {
        type: 'p',
        text: 'Bobby has been a benchmark for Apple-only subscription tracking for good reason. The design is polished and consistent across iPhone, iPad, Mac and Vision, and the Apple Watch support means renewal information is glanceable in a way most trackers cannot match. The spend overview charts are clear without being overwhelming, and the one-time unlock pricing is refreshingly honest.',
      },
      {
        type: 'p',
        text: 'If your devices are all Apple and you prefer entering subscriptions yourself, Bobby delivers one of the nicest manual-tracking experiences available. It proves that a simple tool done beautifully can compete with much larger finance apps.',
      ...
      {
        type: 'h3',
        text: 'What Subby does well',
      },
      {
        type: 'p',
        text: 'Subby is one of the most honest free trackers available. The interface is simple and uncluttered, the unlimited free tier is genuinely unlimited rather than a teaser, and the small one-time purchase to remove ads is priced fairly. It is a great fit for anyone who wants full manual control over their subscription list without signing up for yet another recurring service.',
      },
      {
        type: 'p',
        text: 'For a lightweight, no-surprises mobile tracker, Subby does exactly what it promises. It is particularly appealing to Android users who want a clean app that stays free as long as they are willing to tolerate a few ads.',
        links: [{ text: 'Subby', href: '/compare/subby' }],
      },
      {
        type: 'h2',
      ...
      {
        type: 'p',
        text: 'Unsubby pairs subscription detection with a service that mails cancellation letters to providers on your behalf - useful for the services that make leaving deliberately hard. But it detects subscriptions through a Plaid bank connection, and after a 7-day trial My Unsubby premium is $27.99 every 4 weeks, covering up to five cancellations in that window.',
      },
      {
        type: 'ul',
        items: [
      ...
      {
        type: 'h3',
        text: 'What Unsubby does well',
      },
      {
        type: 'p',
        text: 'Unsubby solves a real problem that most trackers leave to the user: actually getting out of a subscription. Its cancellation-letter service supports more than 1,500 services, which is invaluable for providers that make leaving deliberately difficult. The Plaid-based auto-detection gives users a starting list without manual entry, and the budget planner with spending insights and billing notifications helps keep the picture current.',
      },
      {
        type: 'p',
        text: 'With over 27,000 Trustpilot reviews, Unsubby has clearly built trust with a large audience that values hands-off cancellation help. If your main pain point is the hassle of cancelling rather than the discovery of subscriptions, its approach makes a lot of sense.',
        links: [{ text: 'Unsubby', href: '/compare/unsubby' }],
      },
      {
        type: 'h2',
        text: 'How to Choose',
  ...
  },
  {
    ...
    topics: ['tools', 'money'],
    title: 'A free subscription tracker spreadsheet (and when to ditch it)',
    metaTitle: 'Free Subscription Tracker Spreadsheet',
    description:
    ...
    metaDescription:
      'A ready-to-copy subscription tracker spreadsheet for Google Sheets or Excel: the exact columns, how to total annual cost, and when an app is less upkeep.',
    publishedAt: '2026-07-26',
    updatedAt: '2026-09-02',
    readingTimeMin: 6,
    intro:
    ...
    sections: [
      ...
      },
      {
        ...
        image: {
          src: '/blog/subscription-dashboard-dark.png',
          alt: 'Subscription dashboard with a monthly-spend donut chart and active subscriptions with costs',
          caption:
  ...
  },
  {
    ...
    metaTitle: 'Track Company Software Subscriptions',
    description:
    ...
    metaDescription:
      "Track your company's software subscriptions: surface shadow IT, cut duplicate tools, and catch renewals - no bank access, and no per-seat SaaS bill.",
    publishedAt: '2026-07-26',
    updatedAt: '2026-09-02',
    readingTimeMin: 7,
    intro:
  ...
  },
  {
    ...
    metaTitle: '5 Open Source Personal Finance Tools',
    description:
    ...
    metaDescription:
      'Five open source personal finance tools you can audit or self-host - budgeting, ledgers, subscription tracking, investments - and what each is good at.',
  ...
  },
  {
    ...
    metaTitle: 'What Is a Subscription Tracker?',
    description:
    ...
    metaDescription:
      'A subscription tracker shows every recurring charge in one place. How they work, what types exist, and how to pick one that actually protects your privacy.',
    ...
    sections: [
      ...
      },
      {
        ...
        image: {
          src: '/blog/subscription-dashboard-dark.png',
          alt: 'Subscription tracker dashboard breaking the monthly total down by service, with renewal dates',
          caption:
      ...
      },
      {
        ...
        items: [
          ...
          'PocketGuard: full budgeting plus subscription detection, also bank-linked, $12.99/mo or $74.99/yr or $149.99 lifetime, and no free plan since 2026',
          'Bobby: polished manual tracker, $2.99 one-time unlock, but Apple-only and capped on the free tier',
      ...
      {
        type: 'h2',
        text: 'What the Main Options Do Well',
      },
      {
        type: 'p',
        text: 'Rocket Money and PocketGuard earn their popularity by removing as much friction as possible. Rocket Money includes subscription detection on the free tier and adds bill negotiation and a cancellation concierge that handles the providers most people dread calling. PocketGuard wraps subscription detection in a full budgeting experience across iOS, Android and web, with spending insights and a lifetime purchase option for users who want to avoid another monthly charge.',
        links: [
          { text: 'Rocket Money', href: '/compare/rocket-money' },
          { text: 'PocketGuard', href: '/compare/pocketguard' },
        ],
      ...
      {
        type: 'p',
        text: 'On the manual side, Bobby remains one of the nicest Apple-only trackers, with polished design, Apple Watch support and a cheap one-time unlock. Subby offers a genuinely unlimited free tier that is hard to argue with. YNAB, meanwhile, is overkill for subscriptions alone but is genuinely excellent at what it was built for: teaching a budgeting methodology and giving committed users detailed control over every dollar.',
        links: [
          { text: 'Bobby', href: '/compare/bobby' },
          { text: 'Subby', href: '/compare/subby' },
          { text: 'YNAB', href: '/compare/ynab' },
        ],
      },
      {
        type: 'h2',
  ...
  },
  {
    ...
    metaTitle: 'Best Free Tracker Without Bank Linking',
    description:
    ...
    sections: [
      ...
      },
      {
        ...
        image: {
          ...
          alt: 'Connection screen offering Gmail, Outlook and iCloud, with no bank or card option',
          caption:
      ...
      {
        type: 'p',
        text: 'Bobby is a polished, Apple-only tracker with a clean interface and a small one-time unlock ($2.99 for the All-in-one Pack). It is fully manual, so you enter every subscription yourself, and the free tier is capped until you buy the unlock. Great for iPhone users who want something simple and private.',
      },
      {
        type: 'h3',
        text: 'What Bobby does well',
      ...
      {
        type: 'h3',
        text: 'What a spreadsheet does well',
      },
      {
        type: 'p',
        text: 'A spreadsheet is the most private and flexible way to track subscriptions. Nothing is linked, nothing is shared, and you control every column and formula. For users who enjoy building their own systems or who simply do not want another account, a sheet is a completely valid solution.',
      },
      {
        type: 'p',
        text: 'It also teaches you something about your spending as you build it. Choosing the columns, normalising costs to annual figures, and adding conditional formatting for upcoming renewals turns the process into a small financial audit. The discipline of maintaining it is also what makes some people more aware of their subscriptions, not less.',
        links: [
          { text: 'spreadsheet template', href: '/blog/subscription-tracker-spreadsheet-template' },
        ],
      },
      {
        type: 'h2',
