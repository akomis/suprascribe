...
export const moneyGuides: BlogPost[] = [
  {
    ...
    title: 'Subscription fatigue: how to audit and take back control',
    metaTitle: 'Subscription Fatigue: How to Audit & Fix',
    description:
    ...
    metaDescription:
      'Subscription fatigue is the slow drain of too many small recurring charges. How to audit your subscriptions and stop paying for what you do not use.',
  ...
  },
  {
    ...
    metaTitle: 'Find Hidden Subscriptions on Statements',
    description:
    ...
    metaDescription:
      'Find hidden subscriptions on your bank statement in a 30-minute audit: read the statement, decode labels like APPLE.COM/BILL, and check every app store.',
  ...
  },
  {
    ...
    metaTitle: 'How to Save Money Fast: 5 Real Tactics',
    description:
