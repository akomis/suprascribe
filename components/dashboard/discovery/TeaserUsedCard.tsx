...
const LOCKED_TOOLTIP = 'Free scan already used - click to upgrade to PRO and scan again'
...
export function TeaserUsedCard() {
  ...
  const openUpgrade = () => openUpgradeDialog('discovery_teaser_used_provider')
  ...
  return (
    <div className="fade-on-mount flex flex-col gap-4 rounded-lg border border-dashed p-4 w-[300px] sm:w-[350px] md:w-[450px]">
      ...
      <OneTimePurchaseNote className="text-center pb-2" />
      {canImport ? (
        <UpgradeButton
          showIcon={false}
          variant="default"
