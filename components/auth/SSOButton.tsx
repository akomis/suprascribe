  ...
  azure: {
    ...
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 23 23" fill="none">
        <path d="M0 0h10.75v10.75H0V0z" fill="#F25022" />
        <path d="M12.25 0H23v10.75H12.25V0z" fill="#7FBA00" />
        <path d="M0 12.25h10.75V23H0V12.25z" fill="#00A4EF" />
        <path d="M12.25 12.25H23V23H12.25V12.25z" fill="#FFB900" />
      </svg>
    ),
  },
  apple: {
...
export function SSOButton({ provider, disabled }: SSOButtonProps) {
  ...
  return (
    ...
    >
      {config.icon}
      <span>{loading ? 'Signing in...' : `Continue with ${config.name}`}</span>
    </Button>
  )
}
