  ...
  return (
    <>
      ...
      <section className="container mx-auto px-4 py-12 sm:py-20 max-w-6xl space-y-8">
        {/*
         * The grid needs a heading of its own, and the cards below it have to be h3s.
         * As h2s they made the newest post's title the first h2 of this page *and* of every
         * /blog/category/[category] page that happens to contain it, which is a duplicate-h2
         * pair for something that is really a list item, not a section of this page.
         */}
        <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-center">
          Every Suprascribe guide
        </h2>
